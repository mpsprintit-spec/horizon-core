...
This README defines the documentation foundation for Indonesian language use in context, including intent, politeness, register, implicature, and social meaning. It establishes how future Indonesian language knowledge should be organized while preserving Horizon's principle that knowledge supports responsible, context-aware assistance.

## Purpose

The purpose of this document is to provide standards for future pragmatic documentation without generating interaction datasets. It helps contributors add future resources consistently, review changes predictably, and keep Indonesian language knowledge aligned with Horizon's human-first and knowledge-centered design.

## Scope

This module includes documentation standards, classification rules, metadata expectations, and small illustrative examples for Indonesian language use in context, including intent, politeness, register, implicature, and social meaning.
...
This module interacts with conversation, expressions, semantics, and examples. Cross-references should clarify ownership: each concept should be defined in one primary module and referenced from other modules only when needed. Shared terminology must remain consistent across the Indonesian Language Knowledge Base.
...
```text
knowledge/language/Indonesian/pragmatics/
└── README.md
```
...
- Document how context changes interpretation, including politeness, deixis, implicature, speech acts, and register.
- Identify speaker relationship, setting, intent, and potential safety or trust implications.
- Reference conversation when pragmatic meaning appears through interaction patterns.
